...
| [`docs/deployment.md`](docs/deployment.md) | Operator guide: container, health/readiness/metrics probes, graceful shutdown, resource limits, security, table maintenance (expiry + GC + compaction), full env-var reference. |
